...
- Current checkout: `npm test` passed 9 Rust and 54 Playwright tests; `npm run lint`, `npm run typecheck`, `npm run build`, `npm audit --audit-level=high`, and `cargo package --allow-dirty` passed.
